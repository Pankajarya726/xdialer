...
////        this.getContentResolver().insert(addContactsUri, contentValues);
////
////    }
////
...
////    }
////}
//fun hasWhatsapp(contactID: Int): String {
//        var rowContactId: String
//        var hasWhatsApp: Boolean
//
//        var projection = arrayOf(ContactsContract.RawContacts._ID)
//        var selection: String = ContactsContract.Data.CONTACT_ID + " = ? AND account_type IN (?)";
//        var selectionArgs = arrayOf(contactID.toString(), "com.whatsapp")
...
//        var contactNumber = Uri.encode(contactNumber);
//        var phoneContactID = Random().nextInt();
//        var contactLookupCursor: Cursor? = context.getContentResolver().query(
